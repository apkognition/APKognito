...
!!! example
    ...
    ```asm
    Java_com_apkognition_QuestionableInvoker_ActionContextLocator_LocateContext
    ```
...
All commands are manually implemented wrappers for operations defined in C# ([command bindings](https://github.com/apkognition/APKognito/tree/master/APKognito/ApkMod/Automation/CommandBindings)).
