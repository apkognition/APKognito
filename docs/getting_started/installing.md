...
The latest version of APKognito is always available on our [GitHub Releases page](https://github.com/apkognition/APKognito/releases/latest).
...
[:fontawesome-brands-github: View Current Version File](https://github.com/apkognition/APKognito/blob/master/APKognito/AssemblyInfo.Version.cs){ .md-button .md-button--primary }
