...
public sealed class PackageCompressor
{
    ...
    private sealed class CliToolExecutionResult(int exitCode, string standardError, string command)
    {
        public int ExitCode { get; } = exitCode;

        public string StdErr { get; } = standardError;
    ...
    public class PackageFailureException(int exitCode, string message, string standardError, string command) : Exception(message + $"\nCommand: {command}\nStandard Error:\n{standardError}")
    {
        public int ToolExitCode { get; } = exitCode;
    ...
    public class PackageUnpackFailedException(int exitCode, string message, string standardError, string command) : PackageFailureException(exitCode, message, standardError, command);

    public class PackagePackFailedException(int exitCode, string message, string standardError, string command) : PackageFailureException(exitCode, message, standardError, command);

    public class PackageSignFailedException(int exitCode, string message, string standardError, string command) : PackageFailureException(exitCode, message, standardError, command);
}
