...
internal static class DirectoryManager
{
    ...
    /// <summary>
    /// Creates a <paramref name="directory"/>, then creates a hidden file in that directory.
    /// </summary>
    /// <param name="directory"></param>
    /// <param name="claimName"></param>
    /// <returns>A path to the created hidden file.</returns>
    ...
    /// <summary>
    /// Creates a hidden file in the passed <paramref name="directory"/> if it exists.
    /// </summary>
    /// <param name="directory"></param>
    /// <param name="claimName"></param>
    /// <returns>A path to the created hidden file.</returns>
    ...
    {
        return IsDirectoryClaimed(directory, CLAIM_FILE_NAME);
    }

    public static bool IsDirectoryClaimed(string directory, string claimName)
    {
    ...
    public static string? GetClaimFile(string directory)
    {
        return GetClaimFile(directory, CLAIM_FILE_NAME);
    }

    public static string? GetClaimFile(string directory, string claimName)
    {
    ...
    [DoesNotReturn]
    private static void ThrowFileNotFound(string file)
    {
        throw new FileNotFoundException($"File not found: {file}", file);
    }

    [DoesNotReturn]
    private static void ThrowDirectoryNotFound(string directory)
    {
