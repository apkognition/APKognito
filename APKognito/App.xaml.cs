...
#if DEBUG_ANY
    private static FrameLockDetector s_frameLagDetector { get; set; }
#endif
    ...
    private static readonly IHost s_host = Host
        ...
        .ConfigureServices((__, services) =>
        {
            ...
            _ = services.AddSingleton<ISnackbarService, SnackbarService>()
                ...
                .AddSingleton<IDialogDispatcher, DialogDispatcher>()
                .AddSingleton<SetupWizardWindow>()
                // Pages
                .AddSingleton<HomePage>()
                .AddSingleton<AdbConsolePage>()
                .AddSingleton<AdbConfigurationPage>()
                .AddSingleton<DriveUsagePage>()
                .AddSingleton<FileExplorerPage>()
                .AddSingleton<FileUploaderPage>()
                .AddSingleton<PackageManagerPage>()
                .AddSingleton<RenameConfigurationPage>()
                .AddSingleton<SettingsPage>()
                .AddSingleton<LogViewerPage>()
                // Viewmodels
                .AddSingleton<HomeViewModel>()
                .AddSingleton<MainWindowViewModel>()
                .AddSingleton<SharedViewModel>()
                .AddSingleton<AdbConfigurationViewModel>()
                .AddSingleton<AdbConsoleViewModel>()
                .AddSingleton<DriveUsageViewModel>()
                .AddSingleton<FileExplorerViewModel>()
                .AddSingleton<FileUploaderViewModel>()
                .AddSingleton<PackageManagerViewModel>()
                .AddSingleton<RenameConfigurationViewModel>()
                .AddSingleton<SettingsViewModel>()
                .AddSingleton<LogViewerViewModel>()
                .AddSingleton<JavaInstallationSelectionWindow>()
                .AddSingleton<JavaInstallationSelectionViewModel>();

            // Dialogs
            _ = services.AddTransient<ConsoleDialog>()
                .AddTransient<DirectoryConfirmationDialog>()
                .AddTransient<LogpackCreatorDialog>()
                .AddTransient<PackagePushDialog>()
                .AddTransient<RenamedPackageSelector>();
...
#if DEBUG_ANY
        s_frameLagDetector = new(Dispatcher);
#endif
